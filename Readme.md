...
| **Current** | `analyses` | Per-user skill breakdown (AI/Backend/Frontend/DevOps/Data) |
...
| **Deprecated** | `users_old`, `leaderboard_old`, `api_cache_old` | Legacy tables - kept for backward compatibility |
